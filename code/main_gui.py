...
#Load Images
logo_app = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/512ppi/288ppi.png")#.resize((400, 200), Image.ANTIALIAS)
lib_logo_app = ImageTk.PhotoImage(logo_app)

logo_app_kecil = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/512ppi/1.5x.png")#.resize((400, 200), Image.ANTIALIAS)
lib_logo_app_kecil = ImageTk.PhotoImage(logo_app_kecil)

dash_1 = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/dash_1.jpg").resize((195, 216), Image.ANTIALIAS)
logo_dash_1 = ImageTk.PhotoImage(dash_1)
dash_2 = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/dash_2.jpg").resize((195, 216), Image.ANTIALIAS)
logo_dash_2 = ImageTk.PhotoImage(dash_2)
dash_3 = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/dash_3.jpg").resize((195, 216), Image.ANTIALIAS)
logo_dash_3 = ImageTk.PhotoImage(dash_3)
dash_4 = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/dash_4.jpg").resize((195, 216), Image.ANTIALIAS)
logo_dash_4 = ImageTk.PhotoImage(dash_4)
man = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/man.png").resize((180, 180), Image.ANTIALIAS)
logo_man = ImageTk.PhotoImage(man)
search = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/search.png").resize((80, 80), Image.ANTIALIAS)
logo_search = ImageTk.PhotoImage(search)
search_kecil = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/search.png").resize((10, 10), Image.ANTIALIAS)
logo_search_kecil = ImageTk.PhotoImage(search_kecil)
pinjam = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/pinjam.png").resize((80, 80), Image.ANTIALIAS)
logo_pinjam = ImageTk.PhotoImage(pinjam)
kembali = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/return.png").resize((80, 80), Image.ANTIALIAS)
logo_kembali = ImageTk.PhotoImage(kembali)
riwayat = Image.open("C:/Kampus/Kampus/Elektro/tubespplj/Aset/history.png").resize((80, 80), Image.ANTIALIAS)
...
borrow_text1 = Label(frame4, text="Peminjaman Buku", font=('Muli', 20, 'bold underline'), background=backgroundDasar)
borrow_text1.place(anchor='center', relx=0.25, rely=0.1)

borrow_text2 = Label(frame4, text="Berdasarkan Judul Buku:", font=('Muli', 18), background=backgroundDasar)
borrow_text2.place(anchor='w', relx=0.08, rely=0.2)

search_judul = StringVar()
judulEntry = Entry(frame4, textvariable=search_judul, width = 50)
judulEntry.place(anchor='w',relx=0.08, rely=0.25)  
...
search_button = Button(frame4, image=logo_search_kecil, command=enter_buku)
search_button.place(anchor='w', relx=0.08, rely=0.30)

borrow_text3 = Label(frame4, text="Berdasarkan Kategori Buku:", font=('Muli', 18), background=backgroundDasar)
borrow_text3.place(anchor='w', relx=0.08, rely=0.4)

search_kategori = StringVar()
kategoriEntry = Entry(frame4, textvariable=search_kategori, width = 50)
kategoriEntry.place(anchor='w',relx=0.08, rely=0.45)
